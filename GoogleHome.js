...
//             app.ask(app.buildRichResponse().addSimpleResponse('Here\'s a fact for you' + fact + 'Which one do you want to hear about next, ' + 'Google\'s history or headquarters?')
//             .addBasicCard(app.buildBasicCard(fact).setImage('https://www.w3.org/html/logo/downloads/HTML5_Logo_512.png', 'GoogleImg')))
//             .addSuggestions(['History', 'Headquarters']);
//         } else {
//             app.ask('Here\'s a fact for you. ' + fact + ' Which one do you want to hear about next, ' + ' Google\'s history or headquarters?');
//         }
//     }
    ...
    'default': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        let responseToUser = {
          ...
          speech: requestSource,//'This message is from Dialogflow\'s Cloud Functions for Firebase editor!', // spoken response
